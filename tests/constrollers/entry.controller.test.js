...
const testCases = {
    create: [
        {
            input: {body: {id: 78987, registerId: 1, coaCode: 1010, dc: 1}},
            output: {httpCode: 201, data:{affectedRows: 1}},
            description: 'Success should returning affectedRows = 1'
        },{
            input: {body: {id: 78987, registerIdX: 1, coaCodeX: 1010, dc: 1}},
    ...
    update: [
        {
            input: {body: {id: 78987, coaCode: 1020, dc: 1}},
            output: {httpCode: 200, data:{affectedRows: 1}},
            description: 'Success should returning affectedRows = 1'
        },{
            input: {body: {id: 78987, coaCodeX: 1020, dc: 1}},
            output: {httpCode: 400, code: 'ER_BAD_FIELD_ERROR'},
            description: 'Invalid keys should returning httpCode 400'
        },{
            input: {},
...
const testModule = () => {
    ...
    const controller = (method, req) => entryController[method](req, res, next(req))
