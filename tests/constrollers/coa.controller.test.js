...
const testCases = {
    create: [
        {
            input: {body: {id: 78987, accountId: 1, baseValue: 1000, code: 9090, description: 'New Account'}},
            output: {httpCode: 201, data:{affectedRows: 1}},
            description: 'Success should returning affectedRows = 1'
        },{
            input: {body: {id: 78987, accountIdX: 1, baseValueX: 1000, code: 9090, description: 'New Account'}},
    ...
    update: [
        {
            input: {body: {id: 78987, accountId: 1, baseValue: 1000, code: 9020, description: 'New Description'}},
            output: {httpCode: 200, data:{affectedRows: 1}},
            description: 'Success should returning affectedRows = 1'
        },{
            input: {body: {id: 78987, accountIdX: 1, baseValueX: 1000, code: 9020, description: 'New Description'}},
            output: {httpCode: 400, code: 'ER_BAD_FIELD_ERROR'},
            description: 'Invalid keys should returning httpCode 400'
        },{
            input: {},
