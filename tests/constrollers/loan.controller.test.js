...
const testCases = {
    create: [
        {
            input: {body: {id: 78987, ksmId: 1, startDate: "2022-04-20", amount: 38000000, interestRate: "1.50", duration: 12}},
            output: {httpCode: 201, data:{affectedRows: 1}},
            description: 'Success should returning affectedRows = 1'
        },{
            input: {body: {id: 78987, ksmIdX: 1, startDate: "2022-04-20", amountX: 38000000, interestRate: "1.50", duration: 12}},
...
const testModule = () => {
    ...
    const controller = (method, req) => LoanController[method](req, res, next(req))
