...
const testObj = {
    create: [
        ...
        },
        {
            method: 'POST',
            endpoint: '/',
            input: {id: 1, accountId: 1, baseValue: 1000, code: 9090, description: 'New Account'},
            output: {httpCode: 409},
        ...
        },
        {
            method: 'POST',
            endpoint: '/',
            input: {id: 78987, accountIdX: 1, baseValue: 1000, code: 9090, description: 'New Account'},
            output: {httpCode: 400},
    ...
    findByPk: [
        {
            ...
            endpoint: '/1',
            input: {},
            output: {httpCode: 200, data: [{id: 1, accountId: 1, baseValue: 291350, code: 1010, description: 'Kas UPK'}]},
    ...
    update: [
        ...
        },
        {
            method: 'PUT',
            endpoint: '/',
            input: {id: 99999, accountId: 1, baseValue: 1000, code: 9020, description: 'New Description'},
            output: {httpCode: 404},
        ...
        },
        {
            method: 'PUT',
            endpoint: '/',
            input: {id: 78987, accountId: 1, baseValueX: 1000, code: 9020, description: 'New Description'},
            output: {httpCode: 400},
...
const baseURL = 'http://localhost:6200/api/coa'
