...
const testObj = {
    ...
    findByPk: [
        {
            ...
            endpoint: '/1',
            input: {},
            output: {httpCode: 200, data: [{id: 1, description: 'Aset Lancar'}]},
    ...
    findByKeys: [
        {
            ...
            method: 'GET',
            endpoint: '/?description=Aset Lancar',
            input: {},
            output: {httpCode: 200, data: [{id: 1, description: 'Aset Lancar'}]},
            description: 'request using query array should return data'
        },{
        ...
        {
            method: 'GET',
            endpoint: '/?id=1&description=Aset Lancar',
            input: {},
            output: {httpCode: 200, data: [{id: 1, description: 'Aset Lancar'}]},
            description: 'request using query array should return data'
        }
    ...
    update: [
        ...
        },
        {
            method: 'PUT',
            endpoint: '/',
            input: {id: 99999, description: 'NonExistent'},
            output: {httpCode: 404},
        ...
        },
        {
            method: 'PUT',
            endpoint: '/',
            input: {id: 1, descriptionX: 'InvalidKey'},
            output: {httpCode: 400},
...
const baseURL = 'http://localhost:6200/api/account'
const test = new ApiTestFramework(testObj, baseURL)

const affectedTables = ['account']
