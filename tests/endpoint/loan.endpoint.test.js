    ...
    create: [
        {
            method: 'POST',
            endpoint: '/',
            input: {id: 78987, ksmId: 1, startDate: "2022-04-20", amount: 38000000, interestRate: "1.50", duration: 12},
        ...
        },
        {
            method: 'POST',
            endpoint: '/',
            input: {id: 1, ksmId: 1, startDate: "2022-04-20", amount: 38000000, interestRate: "1.50", duration: 12},
            output: {httpCode: 409},
        ...
        },
        {
            method: 'POST',
            endpoint: '/',
            input: {ksmIdX: 1, startDate: "2022-04-20", amount: 38000000, interestRate: "1.50", duration: 12},
            output: {httpCode: 400},
    ...
    findByPk: [
        {
            ...
            endpoint: '/1',
            input: {},
            output: {httpCode: 200, data: [{id: 1, ksmId: 1, amount: 38000000, interestRate: "1.50", duration: 12}]},
...
const baseURL = 'http://localhost:6200/api/loan'
const test = new ApiTestFramework(testObj, baseURL)

const affectedTables = ['loan', 'ksm']
